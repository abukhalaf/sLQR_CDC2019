...
F = Ki;
[t,x]= ode45(@(t,x) AxBuIntervene(t,x,A,B,Ch,Kh,Ki), t(end) + [0 3.5], x(end,:)');
...
title('Off-Policy Learning of a Minimum Intervention Policy','FontSize',30);xlabel('Time (sec)','FontSize',30);ylabel('State Variables','FontSize',30);
